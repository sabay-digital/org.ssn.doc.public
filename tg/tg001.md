...
The payment provider should check which currencies pre-authorization can be provided for
...
The user and merchant keys should be stored in a record that is associated with the user along with the currencies authorized.
