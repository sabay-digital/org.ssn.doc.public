...
The payment address resolver is implement using the following API [SSN Payment Address Resolver](https://api-reference.ssn.digital/?urls.primaryName=SSN%20payment%20address%20resolver%20API) and returns a simple json object with the payment routing information to be used to build the transaction. 


```bash
curl -X POST "https://pa.ssn.digital/v2/37837941*testing.mysabay.com" \
  -H "accept: application/json" \
  -H "Content-Type: application/json" \
  -d "{\
        \"hash\"         : \"2b74757a2135328153f65e0218d055a0cffc6853bc0e83c5892b52815d8de6ce\"\
        \"signature\"    : \"3c74bebf0cd09b719d429304c3600324b3b4ff75fc48316cb4564e9bda2de9918ed086c453df2d90c42d5cae796dbfd35204c21a5391d230a13bb367fa5ffd06\"\
        \"signer\"       : \"GBIUFPAZAQDUI4U7E4476ARDWYCVAVUE7U7FRMRBQ72D6BRU6JYOVY43\"\
        \"ssn_account\"  : \"GBIUFPAZAQDUI4U7E4476ARDWYCVAVUE7U7FRMRBQ72D6BRU6JYOVY43\"\
      }"
```
...
The resolver for mySabay may return multiple currencies (assets) in which the payment can be made, depending on the assets the payment providers issues and the Sabay accepts. The payment provider should verify if the account to which them payment will be made, has the necessary trustlines for the asset. *This should also have been verified by the payment address resolver, however payment providers are advices to verify the information.*
